        ...
        if (id === "videoLength") {
            ...
            if (videoType.name === "Basic Video Editing") {
                if (e.target.value <= 10) {
                    ...
                    cop.basic.total = 450 + (e.target.value) * 50;
                } else if (e.target.value > 20) {
                    cop.basic.total = 925 + (e.target.value) * 25;
                }
                ...
                if (e.target.value <= 5) {
                    ...
                    cop.twoD.total = 7500 + (e.target.value) * 750;
                } else if (e.target.value > 10 && e.target.value <= 15) {
                    cop.twoD.total = 11250 + (e.target.value) * 375;
                } else if (e.target.value > 15 && e.target.value <= 20) {
                    cop.twoD.total = 13125 + (e.target.value) * 187.5;
                } else if (e.target.value > 20 && e.target.value <= 25) {
                    cop.twoD.total = 14062.5 + (e.target.value) * 93.75;
                } else if (e.target.value > 25 && e.target.value <= 30) {
                    cop.twoD.total = 14531.25 + (e.target.value) * 46.875;
                }
                ...
                if (e.target.value <= 5) {
                    ...
                    cop.threeD.total = 12500 + (e.target.value) * 1250;
                } else if (e.target.value > 10 && e.target.value <= 15) {
                    cop.threeD.total = 18750 + (e.target.value) * 625;
                } else if (e.target.value > 15 && e.target.value <= 20) {
                    cop.threeD.total = 21875 + (e.target.value) * 312.5;
                } else if (e.target.value > 20 && e.target.value <= 25) {
                    cop.threeD.total = 23437.5 + (e.target.value) * 156.25;
                } else if (e.target.value > 25 && e.target.value <= 30) {
                    cop.threeD.total = 23828.125 + (e.target.value) * 78.125;
                }
